...
// import { Box, Button, IconButton, Table, TableBody, TableHead, Typography, Tab, Paper, BottomNavigation, BottomNavigationAction, Container } from '@mui/material';
    ...
    return (
      <>
        ...
        subjectAttendance.length > 0 ? (
          ...
          <h1>Didn't attended any class</h1>
        )}
      </>
    );
  };
