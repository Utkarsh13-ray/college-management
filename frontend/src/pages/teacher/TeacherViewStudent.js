...
const TeacherViewStudent = () => {
  ...
  const teachSubject = currentUser.teachSubject[0]?.subName;
  const teachSubjectID = currentUser.teachSubject[0]?._id;

  // console.log(teachSubjectID);
                ...
                <div>
                  {subjectAttendance &&
                    (() => {
                      let subPr = 0;
                      let chartData = [];
                      const filteredAttendance = subjectAttendance.filter(
                        (attendance) =>
